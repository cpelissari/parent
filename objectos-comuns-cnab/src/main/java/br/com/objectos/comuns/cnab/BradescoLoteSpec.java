...
class BradescoLoteSpec extends CnabLoteSpec implements BradescoLote {
  ...
  private final CnabKey<BradescoLote, String> CONTROLE_PARTICIPANTE = key()
      .id("No. Controle do Participante").at(37, 62).get(String.class);
  ...
  @Override
  public CnabKey<BradescoLote, String> controleDoParticipante() {
