...
public class Cnab implements Modelo {
  ...
  private Cnab(CnabHeaderSpec headerSpec, CnabLoteSpec loteSpec) {
  ...
  private static ArquivoRetorno retornoDe(FixedFile file) {
    ...
    return new ArquivoRetornoPadrao(header, registros);
  }
