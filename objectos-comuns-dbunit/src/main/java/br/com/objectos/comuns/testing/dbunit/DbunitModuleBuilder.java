...
public class DbunitModuleBuilder {
  ...
  public class JndiModuleBuilder {
    ...
    public JndiModuleBuilder catalog(String catalog) {
    ...
    public Module build() {
      return new AbstractModule() {
        ...
        protected void configure() {
          ...
          switch (vendor) {
          case MYSQL:
            bind(VendorConfig.class).toInstance(new MysqlConfig(catalogs));
            break;
          default:
            break;
          }
  ...
  public class JdbcModuleBuilder {
    ...
    public JdbcModuleBuilder addCatalog(String catalog) {
      Preconditions.checkNotNull(catalog);
      catalogs.add(catalog);
      return this;
    }
