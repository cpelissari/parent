 ...
 */
public class FormResponseSerializer extends JsonSerializer<FormResponse> {
  ...
  public void serialize(FormResponse value, JsonGenerator jgen, SerializerProvider provider)
    ...
    jgen.writeStringField("redirectUrl", value.getRedirectUrl());
    jgen.writeBooleanField("valid", value.isValid());
