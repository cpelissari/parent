...
class WebRequestGuice implements WebRequest {
  ...
  @Inject
  public WebRequestGuice(Provider<HttpServletRequest> requests) {
  ...
  public <T> T get(Class<T> objectClass) {
    ...
    return (T) request.getAttribute(objectClass.getName());
  }

  @Override
  public <T> void set(Class<T> objectClass, T value) {
    HttpServletRequest request = requests.get();
    request.setAttribute(objectClass.getName(), value);
  }
