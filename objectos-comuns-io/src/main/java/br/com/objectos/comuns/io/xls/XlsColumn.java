...
class XlsColumn extends AbstractColumn<CellWrapper> {
  ...
  public XlsColumn(Map<ColumnKey<?>, XlsConverter<?>> converterMap, Cell cell) {
    super(converterMap, new PoiCell(cell));
  }

  @Override
  protected boolean isNullOrEmpty(CellWrapper cell) {
    return cell.isNullOrEmpty();
  }

  @Override
  protected CellWrapper cleanValue(CellWrapper cell) {
    return cell;
  }
