...
class BooleanXlsConverter extends AbstractXlsConverter<Boolean> {
  ...
  public BooleanXlsConverter(String trueValue, String falseValue) {
    this.delegate = new BooleanCsvConverter(trueValue, falseValue);
  }

  @Override
  protected Boolean convert(CellWrapper cell) {
